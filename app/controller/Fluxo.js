...
Ext.define('EIA.controller.Fluxo', {
    ...
    destroy: function() {
        ...
        if(records.length === 0){
			...
			Ext.Ajax.request ({
                            scope	: this,
                            url		: '/node/fluxoDelete', //arquivo que contém o método a utilizar
                            params	: {
                                'ids'	: idSel //manda o array idSel para o método excluir o registro 
                            },
        ...
        if (form.isValid()) {
            ...
            {												
                ...
                {						
                    Ext.Ajax.request ({
                        scope	: this,
                        url		: '/node/fluxoUpdate', //arquivo que contém o método a utilizar
                        params	: {
                            'idFluxo'					: idFluxo,
